...
public class Statistics {
    ...
    {
        return "ClassPojo [time = "+time+", activeWorkers = "+activeWorkers+", invalidShares = "+invalidShares+", validShares = "+validShares+", currentHashrate = "+currentHashrate+", staleShares = "+staleShares+", reportedHashrate = "+reportedHashrate+"]";
    }
}