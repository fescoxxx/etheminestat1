...
public class Workers {
    ...
    {
        return "ClassPojo [lastSeen = "+lastSeen+", time = "+time+", invalidShares = "+invalidShares+", validShares = "+validShares+", currentHashrate = "+currentHashrate+", worker = "+worker+", staleShares = "+staleShares+", reportedHashrate = "+reportedHashrate+"]";
    }
}